Shader "Mobile/SpecialDiffuse" {
Properties {
    _MainTex ("Base (RGB)", 2D) = "white" {}
	
	_Color ("Color Tint", Color) = (1,1,1,1)
	_EmTex ("UnlitMap (RGB) Alpha (A)", 2D) = "white" {}
...
SubShader {
    Tags { "RenderType"="Opaque" "Queue"="Transparent" "IgnoreProjector"="True" "RenderType"="TransparentCutoff"}
    LOD 150
